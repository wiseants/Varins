...
namespace HVision.Common.Mvvm
{
    public class MouseBehaviour
    {
        ...
        static void element_MouseUp(object sender, MouseButtonEventArgs e)
        {
			...
			command.Execute(new MouseButtonEventArgsWithSender() { Sender = sender, Args = e });
		}
        ...
        static void element_MouseLeave(object sender, MouseEventArgs e)
        {
			...
			command.Execute(new MouseEventArgsWithSender() { Sender = sender, Args = e });
		}
        ...
        static void element_MouseWheel(object sender, MouseWheelEventArgs e)
        {
			...
			command.Execute(new MouseWheelEventArgsWithSender() { Sender = sender, Args = e });
		}
