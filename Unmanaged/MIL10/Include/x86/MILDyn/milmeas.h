...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasSaveMarkerW  (MIL_CONST_TEXT_PTR FileName,
                                 MIL_ID             MarkerId,
                                 MIL_INT64          ControlFlag);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasRestoreMarkerW(MIL_CONST_TEXT_PTR FileName,
                                  MIL_ID             SystemId,
                                  MIL_INT64          ControlFlag,
                                  MIL_ID*            MarkerIdPtr);

MIL_MEAS_DLLFUNC void MFTYPE MmeasStreamW        (MIL_TEXT_PTR MemPtrOrFileName,
                                 MIL_ID       SystemId,
                                 MIL_INT64    Operation,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasSaveMarkerA  (const char*  FileName,
                                 MIL_ID       MarkerId,
                                 MIL_INT64    ControlFlag);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasRestoreMarkerA(const char* FileName,
                                  MIL_ID      SystemId,
                                  MIL_INT64   ControlFlag,
                                  MIL_ID*     MarkerIdPtr);

MIL_MEAS_DLLFUNC void MFTYPE MmeasStreamA        (char*        MemPtrOrFileName,
                                 MIL_ID       SystemId,
                                 MIL_INT64    Operation,
                                 MIL_INT64    StreamType,
                                 MIL_DOUBLE   Version,
