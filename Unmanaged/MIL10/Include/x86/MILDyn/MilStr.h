...
MIL_STR_DLLFUNC void MFTYPE MstrSaveA            (const char*   FileName,
                                  MIL_ID  ContextId,
                                  MIL_INT64  ControlFlag);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrRestoreA       (const char* FileName,
                                  MIL_ID      SystemId,
                                  MIL_INT64   ControlFlag,
                                  MIL_ID*     ContextIdPtr);

MIL_STR_DLLFUNC void MFTYPE MstrStreamA          (char*         MemPtrOrFileName,
                                  MIL_ID        SystemId,
                                  MIL_INT64     Operation,
...
MIL_STR_DLLFUNC void MFTYPE MstrSaveW            (MIL_CONST_TEXT_PTR  FileName,
                                  MIL_ID        ContextId,
                                  MIL_INT64     ControlFlag);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrRestoreW       (MIL_CONST_TEXT_PTR  FileName,
                                  MIL_ID        SystemId,
                                  MIL_INT64     ControlFlag,
                                  MIL_ID*       ContextIdPtr);

MIL_STR_DLLFUNC void MFTYPE MstrStreamW          (MIL_TEXT_PTR  MemPtrOrFileName,
                                  MIL_ID        SystemId,
                                  MIL_INT64     Operation,
                                  MIL_INT64     StreamType,
                                  MIL_DOUBLE    Version,
