...
#endif
#define M_GLOBAL_FRAME_OFFSET_X_DEPRECATED         1000L
#define M_GLOBAL_FRAME_OFFSET_Y_DEPRECATED         1001L
#define M_GLOBAL_FRAME_ROTATION_DEPRECATED         1002L
#if OldDefinesSupport
...
#define MbeadControlDouble MbeadControl
   ...
   MIL_BEAD_DLLFUNC MIL_ID MFTYPE MbeadRestoreW(MIL_CONST_TEXT_PTR FileName,
                               MIL_ID     SysId,
                               MIL_INT64  ControlFlag,
                               MIL_ID*    ContextBeadIdPtr);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadSaveW(MIL_CONST_TEXT_PTR FileName,
                          MIL_ID     ContextBeadId,
                          MIL_INT64  ControlFlag);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadStreamW(MIL_TEXT_PTR MemPtrOrFileName,
                            MIL_ID     SysId,
                            MIL_INT64  Operation,
   ...
   MIL_BEAD_DLLFUNC MIL_ID MFTYPE MbeadRestoreA(const char* FileName,
                               MIL_ID      SysId,
                               MIL_INT64   ControlFlag,
                               MIL_ID*     ContextBeadIdPtr);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadSaveA(const char* FileName,
                          MIL_ID      ContextBeadId,
                          MIL_INT64   ControlFlag);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadStreamA(char*      MemPtrOrFileName,
                            MIL_ID     SysId,
                            MIL_INT64  Operation,
                            MIL_INT64  StreamType,
                            MIL_DOUBLE Version,
