...
#define M_FUSION                                         1L
#define M_ACCUMULATE_AND_FUSION    (M_ACCUMULATE + M_FUSION)
...
MIL_REG_DLLFUNC MIL_ID MFTYPE MregRestoreW(MIL_CONST_TEXT_PTR FileName,
                           MIL_ID SystemId,
                           MIL_INT64  ControlFlag,
                           MIL_ID *ContextOrResultIdPtr);

MIL_REG_DLLFUNC void MFTYPE MregSaveW(MIL_CONST_TEXT_PTR FileName,
                      MIL_ID ContextOrResultId,
                      MIL_INT64  ControlFlag);

MIL_REG_DLLFUNC void MFTYPE MregStreamW(MIL_TEXT_PTR MemPtrOrFileName,
                        MIL_ID SystemId,
                        MIL_INT64  Operation,
...
MIL_REG_DLLFUNC MIL_ID MFTYPE MregRestoreA(const char* FileName,
                           MIL_ID SystemId,
                           MIL_INT64  ControlFlag,
                           MIL_ID *ContextOrResultIdPtr);

MIL_REG_DLLFUNC void MFTYPE MregSaveA(const char* FileName,
                      MIL_ID ContextOrResultId,
                      MIL_INT64  ControlFlag);

MIL_REG_DLLFUNC void MFTYPE MregStreamA(char* MemPtrOrFileName,
                        MIL_ID SystemId,
                        MIL_INT64  Operation,
                        MIL_INT64  StreamType,
                        MIL_DOUBLE Version,
