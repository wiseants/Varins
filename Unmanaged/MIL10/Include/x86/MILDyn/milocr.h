...
MIL_OCR_DLLFUNC void     MFTYPE MocrImportFontW(MIL_CONST_TEXT_PTR FileName,
                                MIL_INT64  FileFormat,
                                MIL_INT64  Operation,
                                MIL_CONST_TEXT_PTR CharListString,
                                MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC MIL_ID   MFTYPE MocrRestoreFontW(MIL_CONST_TEXT_PTR FileName,
                                 MIL_INT64  Operation,
                                 MIL_ID SystemId,
                                 MIL_ID *FontContextOcrIdPtr);

MIL_OCR_DLLFUNC void     MFTYPE MocrSaveFontW(MIL_CONST_TEXT_PTR FileName,
                              MIL_INT64  Operation,
                              MIL_ID FontContextOcrId);
...
MIL_OCR_DLLFUNC void     MFTYPE MocrStreamW(MIL_TEXT_PTR MemPtrOrFileName    ,
                            MIL_ID       SystemId            ,
                            MIL_INT64    Operation           ,
...
MIL_OCR_DLLFUNC void     MFTYPE MocrImportFontA(const char* FileName,
                                MIL_INT64  FileFormat,
                                MIL_INT64  Operation,
                                const char *CharListString,
                                MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC MIL_ID   MFTYPE MocrRestoreFontA(const char* FileName,
                                 MIL_INT64  Operation,
                                 MIL_ID SystemId,
                                 MIL_ID *FontContextOcrIdPtr);

MIL_OCR_DLLFUNC void     MFTYPE MocrSaveFontA(const char* FileName,
                              MIL_INT64  Operation,
                              MIL_ID FontContextOcrId);
...
MIL_OCR_DLLFUNC void     MFTYPE MocrStreamA(char*        MemPtrOrFileName    ,
                            MIL_ID       SystemId            ,
                            MIL_INT64    Operation           ,
                            MIL_INT64    StreamType          ,
                            MIL_DOUBLE   Version             ,
