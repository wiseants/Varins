...
#define M_NULL                                           0
#endif
#if __cplusplus && (!defined(_MSC_VER) || (_MSC_VER >= 1600))
#else
#endif
...
#define M_STRING_ARRAY_SIZE_BIT                       MAKE_INT64(0x0000060000000000)
...
#define M_STRING_ARRAY_SIZE_BIT_SET(X)                ((M_GET_INTERMOD_VALUE_BITS(X) == M_STRING_ARRAY_SIZE_BIT) ? true : false)
#define M_STRIP_STRING_ARRAY_SIZE_BIT(X)              M_STRIP_INTERMOD_VALUE_BITS(X)
...
/* Free for future system type                        18L*/
...
#define M_GC_ACTION                                   0x0
#define M_GC_ACTION0                                  ((M_GC_ACTION+0)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION1                                  ((M_GC_ACTION+1)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION2                                  ((M_GC_ACTION+2)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION3                                  ((M_GC_ACTION+3)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION4                                  ((M_GC_ACTION+4)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION5                                  ((M_GC_ACTION+5)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION6                                  ((M_GC_ACTION+6)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION7                                  ((M_GC_ACTION+7)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION8                                  ((M_GC_ACTION+8)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION9                                  ((M_GC_ACTION+9)  << M_GC_ACTION_SHIFT)
#define M_GC_ACTION10                                 ((M_GC_ACTION+10) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION11                                 ((M_GC_ACTION+11) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION12                                 ((M_GC_ACTION+12) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION13                                 ((M_GC_ACTION+13) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION14                                 ((M_GC_ACTION+14) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION15                                 ((M_GC_ACTION+15) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION16                                 ((M_GC_ACTION+16) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION17                                 ((M_GC_ACTION+17) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION18                                 ((M_GC_ACTION+18) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION19                                 ((M_GC_ACTION+19) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION20                                 ((M_GC_ACTION+20) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION21                                 ((M_GC_ACTION+21) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION22                                 ((M_GC_ACTION+22) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION23                                 ((M_GC_ACTION+23) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION24                                 ((M_GC_ACTION+24) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION25                                 ((M_GC_ACTION+25) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION26                                 ((M_GC_ACTION+26) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION27                                 ((M_GC_ACTION+27) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION28                                 ((M_GC_ACTION+28) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION29                                 ((M_GC_ACTION+29) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION30                                 ((M_GC_ACTION+30) << M_GC_ACTION_SHIFT)
#define M_GC_ACTION31                                 ((M_GC_ACTION+31) << M_GC_ACTION_SHIFT)
...
#define M_CORE_ID_FORCE_BIT                           0x00001000L
#define M_CORE_ID_FORCE(X)                            (M_CORE_ID_FORCE_BIT | ((X & 0x3F) << 6))
#define M_EXTRACT_CORE_ID(X)                          ((X >> 6) & 0x3F)
#define M_CORE_ID_FORCE_MASK                          M_CORE_ID_FORCE(63)
...
#define M_SHADING_CORRECTION_GAIN_FIX_POINT           5217L
...
#define M_DIG_INQUIRE_STRING_START                    7700L
      ...
      #define M_GC_UNIQUE_ID_STRING                            (M_GC_MAC_ADDRESS_STRING|M_CLIENT_ASCII_MODE)
      ...
      #define M_GC_UNIQUE_ID_STRING                            M_GC_MAC_ADDRESS_STRING
...
#define M_GRAB_CUSTOM_EXTENDED_DATA                   8100L
#define M_MODE1                                           1L

/* Reserve next 100 values                     from   8101L*/
/*                                             to     8199L*/
#define M_GRAB_CUSTOM_EXTENDED_DATA_ID                8200L
...
#define M_HOOK_DATA_INSTANCE_BITSHIFT                  (16)
#define M_HOOK_DATA_INSTANCE_MASK                      (0xffff << M_HOOK_DATA_INSTANCE_BITSHIFT)
#define M_HOOK_DATA_INSTANCE(Instance)                (Instance << M_HOOK_DATA_INSTANCE_BITSHIFT)
#define M_HOOK_DATA_PARSING_MODE                      8300L
#define M_HOOK_DATA_MAX_INDEX                         0x20 
#define M_HOOK_DATA_INDEX_START                       8304L
#define M_HOOK_DATA_STATE                             (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*0)
#define M_HOOK_DATA_TYPE                              (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*1)
#define M_HOOK_DATA_LATCH                             (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*2)
#define M_HOOK_DATA_LATCH_MODE                        (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*3)
#define M_HOOK_DATA_BUFFER_LATCH                      (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*4)
#define M_HOOK_DATA_CALLBACK                          (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*5)
#define M_HOOK_DATA_FLUSH_LATCH                       (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*6)
// Used in the callback
#define M_HOOK_DATA_SIZE                              (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*8)
#define M_HOOK_DATA_SIZE_BYTE                         (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*9)
#define M_HOOK_DATA_ALL                               (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*10)
#define M_HOOK_DATA                                   (M_HOOK_DATA_INDEX_START + M_HOOK_DATA_MAX_INDEX*11)
#define M_HOOK_DATA_EXTRACT_INDEX_FROM_TYPE(TYPE)     ((((TYPE)&~M_HOOK_DATA_INSTANCE_MASK) - M_HOOK_DATA_INDEX_START) % M_HOOK_DATA_MAX_INDEX)
#define M_HOOK_DATA_EXTRACT_INSTANCE_FROM_TYPE(TYPE)  ((((TYPE) & M_HOOK_DATA_INSTANCE_MASK) >> M_HOOK_DATA_INSTANCE_BITSHIFT))
#define M_HOOK_DATA_EXTRACT_TYPE(TYPE)                (((TYPE)&~M_HOOK_DATA_INSTANCE_MASK) - M_HOOK_DATA_EXTRACT_INDEX_FROM_TYPE(TYPE))
...
// Values to control M_HOOK_DATA_TYPE
#define M_IO_STATUS_ALL                       (M_USER_BIT_BIT_MASK_ENABLED|M_IO_STATUS)
#define M_ROTARY_ENCODER                       0x700L
#define M_ROTARY_ENCODER1                      (M_ROTARY_ENCODER +M_ROTARY_MAX_OUTPUT)
#define M_ROTARY_ENCODER2                      (M_ROTARY_ENCODER1+M_ROTARY_MAX_OUTPUT)
...
#define M_HOOK_DATA_CXP_HEADER_PIXEL_FORMAT    0x4
#define M_HOOK_DATA_CXP_HEADER_X_SIZE_OFFSET   0x6
#define M_HOOK_DATA_CXP_HEADER_Y_SIZE_OFFSET   0x5

// Values to control M_HOOK_DATA_LATCH_MODE
#define M_NORMAL                                8L
...
#define M_GC_FEATURE_CHANGE                           26L
...
#if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL)
#define M_GC_FEATURE_CHANGE_NAME                      (0x00870000L|M_CLIENT_ASCII_MODE)
#else
#define M_GC_FEATURE_CHANGE_NAME                      0x00870000L
#endif
...
/************************************************************************/
#define M_STRING_ARRAY_SIZE_MASK                      MAKE_INT64(0x0000000000FFFFFF)
#define M_STRING_ARRAY_SIZE_SHIFT                     MAKE_INT64(0x0000000000000000)
#define M_STRING_ARRAY_SIZE(N)                        (M_STRING_ARRAY_SIZE_BIT + (((N) & M_STRING_ARRAY_SIZE_MASK) << M_STRING_ARRAY_SIZE_SHIFT))
...
#define M_REG_DEF_DIG_SW_FORMAT_SIZE         (M_STRING_SIZE + M_REG_DEF_DIG_SW_FORMAT)
         ...
         #if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL)
            #define M_REG_DEF_BOARD_NAME_OLD          ((M_APP_INQUIRE_SYS_START+ 977L)|M_CLIENT_ASCII_MODE)
            /* Reserve values from                    ((M_APP_INQUIRE_SYS_START+ 978L)|M_CLIENT_ASCII_MODE)*/
            /*                to                      ((M_APP_INQUIRE_SYS_START+ 992L)|M_CLIENT_ASCII_MODE)*/
            #define M_REG_DEF_SYSTEM_NAME_OLD         ((M_APP_INQUIRE_SYS_START+ 993L)|M_CLIENT_ASCII_MODE)
            /* Reserve values from                    ((M_APP_INQUIRE_SYS_START+ 994L)|M_CLIENT_ASCII_MODE)*/
            /*                to                      ((M_APP_INQUIRE_SYS_START+1008L)|M_CLIENT_ASCII_MODE)*/
            #define M_REG_DEF_SYSTEM_DISPLAYABLE_NAME_OLD  ((M_APP_INQUIRE_SYS_START+1009L)|M_CLIENT_ASCII_MODE)
            ...
            #define M_REG_DEF_DISPLAY_FORMAT_OLD      ((M_APP_INQUIRE_SYS_START+1025L)|M_CLIENT_ASCII_MODE)
            ...
            #define M_REG_DEF_DIG_FORMAT_OLD           ((M_APP_INQUIRE_SYS_START+1041L)|M_CLIENT_ASCII_MODE)
            ...
            #define M_REG_DEF_DIG_DEV_NAME_OLD        ((M_APP_INQUIRE_SYS_START+1057L)|M_CLIENT_ASCII_MODE)
            ...
            #define M_REG_DEF_DIG_SW_FORMAT_OLD       ((M_APP_INQUIRE_SYS_START+1073L)|M_CLIENT_ASCII_MODE)
         ...
         #define M_REG_DEF_BOARD_NAME_SIZE_OLD            (M_STRING_SIZE + M_REG_DEF_BOARD_NAME_OLD)
         #define M_REG_DEF_SYSTEM_NAME_SIZE_OLD           (M_STRING_SIZE + M_REG_DEF_SYSTEM_NAME_OLD)
         #define M_REG_DEF_SYSTEM_DISPLAYABLE_NAME_SIZE_OLD (M_STRING_SIZE + M_REG_DEF_SYSTEM_DISPLAYABLE_NAME_OLD)
         #define M_REG_DEF_DISPLAY_FORMAT_SIZE_OLD        (M_STRING_SIZE + M_REG_DEF_DISPLAY_FORMAT_OLD)
         #define M_REG_DEF_DIG_FORMAT_SIZE_OLD            (M_STRING_SIZE + M_REG_DEF_DIG_FORMAT_OLD)
         #define M_REG_DEF_DIG_DEV_NAME_SIZE_OLD          (M_STRING_SIZE + M_REG_DEF_DIG_DEV_NAME_OLD)
         #define M_REG_DEF_DIG_SW_FORMAT_SIZE_OLD         (M_STRING_SIZE + M_REG_DEF_DIG_SW_FORMAT_OLD)
#endif
...
#define M_INSTALLED_SYSTEM_REG_KEY_NAME     ((M_APP_INQUIRE_SYS_START+1832L)|M_CLIENT_ASCII_MODE)
#elif MIL_COMPILE_VERSION < 1060
      #define M_INSTALLED_SYSTEM_DESCRIPTOR_OLD       ((M_APP_INQUIRE_SYS_START+1800L)|M_CLIENT_ASCII_MODE)
      ...
      #define M_INSTALLED_SYSTEM_PRINT_NAME_OLD       ((M_APP_INQUIRE_SYS_START+1816L)|M_CLIENT_ASCII_MODE)
      ...
      #define M_INSTALLED_SYSTEM_REG_KEY_NAME_OLD     ((M_APP_INQUIRE_SYS_START+1832L)|M_CLIENT_ASCII_MODE)
      ...
      #define M_TRACE_SAVE_TO_FILE                    ((M_APP_INQUIRE_SYS_START+1850L)|M_CLIENT_ASCII_MODE)
   #else
#if MIL_COMPILE_VERSION < 1010
...
#define M_INSTALLED_SYSTEM_REG_KEY_NAME     (M_APP_INQUIRE_SYS_START+1832L)
#elif MIL_COMPILE_VERSION < 1060
      #define M_INSTALLED_SYSTEM_DESCRIPTOR_OLD       (M_APP_INQUIRE_SYS_START+1800L)
      /* Reserve next 15 values               from    (M_APP_INQUIRE_SYS_START+1801L)*/
      /*                                      to      (M_APP_INQUIRE_SYS_START+1815L)*/
      #define M_INSTALLED_SYSTEM_PRINT_NAME_OLD       (M_APP_INQUIRE_SYS_START+1816L)
      /* Reserve next 15 values               from    (M_APP_INQUIRE_SYS_START+1817L)*/
      /*                                      to      (M_APP_INQUIRE_SYS_START+1831L)*/
      #define M_INSTALLED_SYSTEM_REG_KEY_NAME_OLD     (M_APP_INQUIRE_SYS_START+1832L)
      ...
      #define M_TRACE_SAVE_TO_FILE                    (M_APP_INQUIRE_SYS_START+1850L)
   #endif
...
#if MIL_COMPILE_VERSION >= 1010
#if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL)
#define M_INSTALLED_SYSTEM_DESCRIPTOR           ((M_APP_INQUIRE_SYS_START+7000L)|M_CLIENT_ASCII_MODE)
/* Reserve next 63 values               from    ((M_APP_INQUIRE_SYS_START+7001L)|M_CLIENT_ASCII_MODE)*/
/*                                      to      ((M_APP_INQUIRE_SYS_START+7063L)|M_CLIENT_ASCII_MODE)*/
#define M_INSTALLED_SYSTEM_PRINT_NAME           ((M_APP_INQUIRE_SYS_START+7064L)|M_CLIENT_ASCII_MODE)
/* Reserve next 63 values               from    ((M_APP_INQUIRE_SYS_START+7065L)|M_CLIENT_ASCII_MODE)*/
/*                                      to      ((M_APP_INQUIRE_SYS_START+7127L)|M_CLIENT_ASCII_MODE)*/
#define M_INSTALLED_SYSTEM_REG_KEY_NAME         ((M_APP_INQUIRE_SYS_START+7128L)|M_CLIENT_ASCII_MODE)
/* Reserve next 63 values               from    ((M_APP_INQUIRE_SYS_START+7129L)|M_CLIENT_ASCII_MODE)*/
/*                                      to      ((M_APP_INQUIRE_SYS_START+7191L)|M_CLIENT_ASCII_MODE)*/
#else
#define M_INSTALLED_SYSTEM_DESCRIPTOR           (M_APP_INQUIRE_SYS_START+7000L)
/* Reserve next 63 values               from    (M_APP_INQUIRE_SYS_START+7001L)*/
/*                                      to      (M_APP_INQUIRE_SYS_START+7063L)*/
#define M_INSTALLED_SYSTEM_PRINT_NAME           (M_APP_INQUIRE_SYS_START+7064L)
/* Reserve next 63 values               from    (M_APP_INQUIRE_SYS_START+7065L)*/
/*                                      to      (M_APP_INQUIRE_SYS_START+7127L)*/
#define M_INSTALLED_SYSTEM_REG_KEY_NAME         (M_APP_INQUIRE_SYS_START+7128L)
/* Reserve next 63 values               from    (M_APP_INQUIRE_SYS_START+7129L)*/
/*                                      to      (M_APP_INQUIRE_SYS_START+7191L)*/
#endif
...
#define M_SYS_APP_INQUIRE_STRING_2_END             (M_APP_INQUIRE_SYS_START+7199L)
...
#if MIL_COMPILE_VERSION >= 1010
#if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL)
#define M_REG_DEF_BOARD_NAME              ((M_APP_INQUIRE_SYS_START+8000L)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+8001L)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8063L)|M_CLIENT_ASCII_MODE)*/
#define M_REG_DEF_SYSTEM_NAME             ((M_APP_INQUIRE_SYS_START+8064L)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+8065L)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8127L)|M_CLIENT_ASCII_MODE)*/
#define M_REG_DEF_SYSTEM_DISPLAYABLE_NAME ((M_APP_INQUIRE_SYS_START+8128L)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+8129L)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8191L)|M_CLIENT_ASCII_MODE)*/
#define M_REG_DEF_DISPLAY_FORMAT          ((M_APP_INQUIRE_SYS_START+8192L)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+8193L)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8255L)|M_CLIENT_ASCII_MODE)*/
#define M_REG_DEF_DIG_FORMAT              ((M_APP_INQUIRE_SYS_START+856LL)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+857LL)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8319L)|M_CLIENT_ASCII_MODE)*/
#define M_REG_DEF_DIG_DEV_NAME            ((M_APP_INQUIRE_SYS_START+8320L)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+8321L)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8383L)|M_CLIENT_ASCII_MODE)*/
#define M_REG_DEF_DIG_SW_FORMAT           ((M_APP_INQUIRE_SYS_START+8384L)|M_CLIENT_ASCII_MODE)
/* Reserve values from                    ((M_APP_INQUIRE_SYS_START+8385L)|M_CLIENT_ASCII_MODE)*/
/*                to                      ((M_APP_INQUIRE_SYS_START+8447L)|M_CLIENT_ASCII_MODE)*/
/* The next values are available from     ((M_APP_INQUIRE_SYS_START+8448L)|M_CLIENT_ASCII_MODE)*/
/*                               to       ((M_APP_INQUIRE_SYS_START+8959L)|M_CLIENT_ASCII_MODE)*/
#else
#define M_REG_DEF_BOARD_NAME              (M_APP_INQUIRE_SYS_START+8000L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+8001L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8063L)*/
#define M_REG_DEF_SYSTEM_NAME             (M_APP_INQUIRE_SYS_START+8064L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+8065L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8127L)*/
#define M_REG_DEF_SYSTEM_DISPLAYABLE_NAME (M_APP_INQUIRE_SYS_START+8128L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+8129L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8191L)*/
#define M_REG_DEF_DISPLAY_FORMAT          (M_APP_INQUIRE_SYS_START+8192L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+8193L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8255L)*/
#define M_REG_DEF_DIG_FORMAT              (M_APP_INQUIRE_SYS_START+8256L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+857L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8319L)*/
#define M_REG_DEF_DIG_DEV_NAME            (M_APP_INQUIRE_SYS_START+8320L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+8321L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8383L)*/
#define M_REG_DEF_DIG_SW_FORMAT           (M_APP_INQUIRE_SYS_START+8384L)
/* Reserve values from                    (M_APP_INQUIRE_SYS_START+8385L)*/
/*                to                      (M_APP_INQUIRE_SYS_START+8447L)*/
/* The next values are available from     (M_APP_INQUIRE_SYS_START+8448L)*/
/*                               to       (M_APP_INQUIRE_SYS_START+8959L)*/
#endif
...
#if MIL_COMPILE_VERSION >= 1010
#define M_REG_DEF_SYSTEM_DEV                    (M_APP_INQUIRE_SYS_START+8960L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+8961)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9023L)*/
#define M_REG_DEF_BUFFER_SIZEBAND               (M_APP_INQUIRE_SYS_START+9024L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9025L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9087L)*/
#define M_REG_DEF_BUFFER_SIZEX                  (M_APP_INQUIRE_SYS_START+9088L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9089L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9151L)*/
#define M_REG_DEF_BUFFER_SIZEY                  (M_APP_INQUIRE_SYS_START+9152L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9153L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9215L)*/
#define M_REG_DEF_DISPLAY_DEV                   (M_APP_INQUIRE_SYS_START+9216L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9217L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9279L)*/
#define M_REG_DEF_DISPLAY_TYPE                  (M_APP_INQUIRE_SYS_START+9280L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9281L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9343L)*/
#define M_REG_DEF_DIG_DEV                       (M_APP_INQUIRE_SYS_START+9344L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9345L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9407L)*/
#define M_REG_DEF_SYSTEM_CAN_GRAB               (M_APP_INQUIRE_SYS_START+9408L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9409L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9471L)*/
#define M_REG_DEF_SYSTEM_SUPPORTS_AUX_DISPLAY   (M_APP_INQUIRE_SYS_START+9472L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9473L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9535L)*/
#define M_REG_DEF_DIG_INIT_FLAG                 (M_APP_INQUIRE_SYS_START+9536L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9537L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9599L)*/
#define M_REG_DEF_SYSTEM_SUPPORTS_DEV_NAME      (M_APP_INQUIRE_SYS_START+9600L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9601L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9663L)*/
#define M_REG_DEF_SYSTEM_USES_SOFTWARE_GRAB     (M_APP_INQUIRE_SYS_START+9664L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9665L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9727L)*/
#endif
...
#define M_LIC_FINGERPRINT_TYPE(N)                     (M_LICENSE_FINGERPRINT+(N * M_MAX_SYSTEMS_PER_TYPE))
...
#define M_FUNC_INQUIRE_STRING_START                   47
      ...
      #define M_SCRIPT_FUNCTION_NAME                  ((M_FUNC_INQUIRE_STRING_START+5)|M_CLIENT_ASCII_MODE)
      #define M_INTERPRETER_PATH                      M_SLAVE_DLL_NAME
      #define M_SCRIPT_PATH                           ((M_FUNC_INQUIRE_STRING_START+6)|M_CLIENT_ASCII_MODE)
      #define M_DEBUG_INFORMATION_PATH                ((M_FUNC_INQUIRE_STRING_START+7)|M_CLIENT_ASCII_MODE)
      #define M_ADD_SCRIPT_REFERENCE                  ((M_FUNC_INQUIRE_STRING_START+8)|M_CLIENT_ASCII_MODE)
      /* Reserve next values  from                    ((M_FUNC_INQUIRE_STRING_START+9)|M_CLIENT_ASCII_MODE)
      ...
      #define M_SCRIPT_FUNCTION_NAME                  (M_FUNC_INQUIRE_STRING_START+5)
      #define M_INTERPRETER_PATH                      M_SLAVE_DLL_NAME
      #define M_SCRIPT_PATH                           (M_FUNC_INQUIRE_STRING_START+6)
      #define M_DEBUG_INFORMATION_PATH                (M_FUNC_INQUIRE_STRING_START+7)
      #define M_ADD_SCRIPT_REFERENCE                  (M_FUNC_INQUIRE_STRING_START+8)
      /* Reserve next values  from                    (M_FUNC_INQUIRE_STRING_START+9)
...
#if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL)
   #define M_SCRIPT_REFERENCE                   (M_SCRIPT_REFERENCE_START|M_CLIENT_ASCII_MODE)
#else
   #define M_SCRIPT_REFERENCE                   M_SCRIPT_REFERENCE_START
#endif
...
#define M_IN_SYS_APP_INQUIRE_STRING_RANGE(X)             ( (((X&~M_CLIENT_ASCII_MODE) >= M_SYS_APP_INQUIRE_STRING_START) && \
                                                           ...
                                                           (((X&~M_CLIENT_ASCII_MODE) >= M_SYS_APP_INQUIRE_STRING_2_START) && \
                                                            ((X&~M_CLIENT_ASCII_MODE) <= M_SYS_APP_INQUIRE_STRING_2_END  ) ) )
...
#define M_IN_APP_INQUIRE_REG_DEF_STRING_RANGE(X)         ( (((X&~M_CLIENT_ASCII_MODE) >= M_APP_INQUIRE_REG_DEF_STRING_START) && \
                                                          ...
                                                          (((X&~M_CLIENT_ASCII_MODE) >= M_APP_INQUIRE_REG_DEF_STRING_2_START) && \
                                                          ((X&~M_CLIENT_ASCII_MODE) <= M_APP_INQUIRE_REG_DEF_STRING_2_END  )   ))
...
#define M_IN_FUNC_INQUIRE_STRING_RANGE(X)                ((((X&~M_CLIENT_ASCII_MODE) >= M_FUNC_INQUIRE_STRING_START) && \
                                                          ...
                                                          (((X&~M_CLIENT_ASCII_MODE) >= M_SCRIPT_REFERENCE_START) &&   \
                                                          ((X&~M_CLIENT_ASCII_MODE) <= M_SCRIPT_REFERENCE_END)))
...
#define M_IN_SYS_GET_HOOK_INFO_INT64_RANGE(X)           (((X&~(M_INTERMOD_VALUE_MASK|M_MODIFIED_BUFFER)) == M_GC_MAC_ADDRESS             ) || \
    ((X&~(M_INTERMOD_VALUE_MASK|M_MODIFIED_BUFFER)) == M_GC_MAC_ADDRESS             ) || \
...
//////////////////////////////////////////////////////////////////////////
// MDigGetHookInfo (InquireType range values)
#define M_IN_DIG_GET_HOOK_INFO_STRING_RANGE(X)           (((X&(~M_CLIENT_ASCII_MODE)) == (M_GC_FEATURE_CHANGE_NAME&(~M_CLIENT_ASCII_MODE)) ) )

//////////////////////////////////////////////////////////////////////////
// MDigGetHookInfo (InfoType range values)
#define M_IN_DIG_GET_HOOK_INFO_INT64_RANGE(X)            (((X&~M_HOOK_DATA_INSTANCE_MASK) >= M_HOOK_DATA) && ((X&~M_HOOK_DATA_INSTANCE_MASK) < (M_HOOK_DATA+M_HOOK_DATA_MAX_INDEX)))

//////////////////////////////////////////////////////////////////////////
// MDigGetHookInfo (InfoType range values)
#define M_IN_DIG_GET_HOOK_INFO_PTR_RANGE(X)               ((X == M_DRIVER_HOOK_CONTEXT_PTR) || \
                                                          ((X >= M_HOOK_DATA_ALL) && (X < (M_HOOK_DATA_ALL+M_HOOK_DATA_MAX_INDEX))))
