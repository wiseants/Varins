...
#define M_COLOR_CALIBRATION_COMPUTE_OPTION        1878L        // used in color calibration context
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolRestoreW(MIL_CONST_TEXT_PTR FileName,
                           MIL_ID SystemId,
                           MIL_INT64  ControlFlag,
                           MIL_ID *ContextIdPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolSaveW(MIL_CONST_TEXT_PTR FileName,
                      MIL_ID ContextId,
                      MIL_INT64  ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolStreamW(MIL_TEXT_PTR   MemPtrOrFileName,
                        MIL_ID         SystemId,
                        MIL_INT64      Operation,
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolRestoreA(const char* FileName,
                           MIL_ID      SystemId,
                           MIL_INT64   ControlFlag,
                           MIL_ID*     ContextIdPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolSaveA(const char* FileName,
                      MIL_ID      ContextId,
                      MIL_INT64   ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolStreamA(char*      MemPtrOrFileName,
                        MIL_ID     SystemId,
                        MIL_INT64  Operation,
                        MIL_INT64  StreamType,
                        MIL_DOUBLE Version,
