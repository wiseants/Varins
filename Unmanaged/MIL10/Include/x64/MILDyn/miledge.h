...
#define M_PREWITT                            M_EDGE_DETECT_PREWITT_FAST // Already defined in mil.hL
...
/* MedgePut()                                                              */
/***************************************************************************/
MIL_EDGE_DLLFUNC void MFTYPE    MedgePut          (MIL_ID            EdgeResultId,
                                  MIL_INT           NbEdgels,
...
/* MedgeSave() Unicode                                                     */
/***************************************************************************/
MIL_EDGE_DLLFUNC void MFTYPE    MedgeSaveW         (MIL_CONST_TEXT_PTR FileName,
...
/***************************************************************************/
MIL_EDGE_DLLFUNC MIL_ID  MFTYPE MedgeRestoreW      (MIL_CONST_TEXT_PTR FileName,
                                   MIL_ID       SystemId,
                                   MIL_INT64    ControlFlag,
                                   MIL_ID*      ContextIdPtr);
...
/* MedgeStream() Unicode                                                   */
/***************************************************************************/
MIL_EDGE_DLLFUNC void MFTYPE    MedgeStreamW      (MIL_TEXT_PTR MemPtrOrFileName,
                                  MIL_ID       SystemId,
                                  MIL_INT64    Operation,
...
/* MedgeSave() ASCII                                                       */
/***************************************************************************/
MIL_EDGE_DLLFUNC void MFTYPE    MedgeSaveA         (const char*  FileName,
                                   MIL_ID       ContextOrResultId,
                                   MIL_INT64    ControlFlag);
...
/* MedgeRestore() ASCII                                                    */
/***************************************************************************/
MIL_EDGE_DLLFUNC MIL_ID  MFTYPE MedgeRestoreA      (const char*  FileName,
                                   MIL_ID       SystemId,
                                   MIL_INT64    ControlFlag,
                                   MIL_ID*      ContextIdPtr);
...
/* MedgeStream() ASCII                                                     */
/***************************************************************************/
MIL_EDGE_DLLFUNC void MFTYPE    MedgeStreamA      (char*      MemPtrOrFileName,
                                  MIL_ID     SystemId,
                                  MIL_INT64  Operation,
                                  MIL_INT64  StreamType,
                                  MIL_DOUBLE Version,
