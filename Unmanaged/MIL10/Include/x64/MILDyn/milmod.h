...
#endif
#define M_SEARCH_OFFSET_X_DEPRECATED    102L
#define M_SEARCH_OFFSET_Y_DEPRECATED    103L
#define M_SEARCH_SIZE_X_DEPRECATED      104L
#define M_SEARCH_SIZE_Y_DEPRECATED      105L 
...
MIL_MOD_DLLFUNC void MFTYPE MmodSaveW           (MIL_CONST_TEXT_PTR   FileName,
                                 MIL_ID         ContextId,
                                 MIL_INT64      ControlFlag);

MIL_MOD_DLLFUNC MIL_ID  MFTYPE MmodRestoreW     (MIL_CONST_TEXT_PTR   FileName,
                                 MIL_ID         SystemId, 
                                 MIL_INT64      ControlFlag,
                                 MIL_ID*        ContextIdPtr);

MIL_MOD_DLLFUNC void MFTYPE MmodStreamW         (MIL_TEXT_PTR   MemPtrOrFileName,
                                 MIL_ID         SystemId,
                                 MIL_INT64      Operation,
...
MIL_MOD_DLLFUNC void MFTYPE MmodSaveA           (const char*    FileName,
                                 MIL_ID         ContextId,
                                 MIL_INT64      ControlFlag);

MIL_MOD_DLLFUNC MIL_ID  MFTYPE MmodRestoreA     (const char*    FileName,
                                 MIL_ID         SystemId, 
                                 MIL_INT64      ControlFlag,
                                 MIL_ID*        ContextIdPtr);

MIL_MOD_DLLFUNC void MFTYPE MmodStreamA         (char*          MemPtrOrFileName,
                                 MIL_ID         SystemId,
                                 MIL_INT64      Operation,
                                 MIL_INT64      StreamType,
                                 MIL_DOUBLE     Version,
