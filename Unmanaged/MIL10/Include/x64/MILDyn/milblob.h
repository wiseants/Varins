...
#define M_FERET_ANGLE_SEARCH_START           90L   // Already defined in milEdge.h
#define M_FERET_ANGLE_SEARCH_END             92L   // Already defined in milEdge.h
 ...
 * Function prototypes
 ********************************************************************/
MIL_BLOB_DLLFUNC MIL_ID MFTYPE MblobAllocFeatureList(MIL_ID SystemId,MIL_ID* FeatureListIdPtr);
MIL_BLOB_DLLFUNC MIL_ID MFTYPE MblobAllocResult(MIL_ID SystemId, MIL_ID* BlobResIdPtr);
MIL_BLOB_DLLFUNC void MFTYPE MblobCalculate(MIL_ID BlobIdentImageId, MIL_ID GrayImageId,
              MIL_ID FeatureListId, MIL_ID BlobResId);

#if M_MIL_USE_64BIT
// Prototypes for 64 bits OSs
MIL_BLOB_DLLFUNC void MFTYPE MblobControlInt64(MIL_ID BlobResId, MIL_INT64  ControlType, MIL_INT64 ControlValue);
MIL_BLOB_DLLFUNC void MFTYPE MblobControlDouble(MIL_ID BlobResId, MIL_INT64  ControlType, MIL_DOUBLE ControlValue);
#else
// Prototypes for 32 bits OSs
#define MblobControlInt64  MblobControl
#define MblobControlDouble MblobControl
MIL_BLOB_DLLFUNC void MFTYPE MblobControl(MIL_ID BlobResId, MIL_INT64  ControlType, MIL_DOUBLE ControlValue);
#endif

MIL_BLOB_DLLFUNC void MFTYPE MblobFill(MIL_ID BlobResId, MIL_ID DestImageBufId, MIL_INT64  Criterion, MIL_INT Value);
MIL_BLOB_DLLFUNC void MFTYPE MblobFree(MIL_ID BlobId);
MIL_BLOB_DLLFUNC MIL_INT MFTYPE MblobGetLabel(MIL_ID BlobResId, MIL_INT XPos, MIL_INT YPos, MIL_INT* LabelVarPtr);
MIL_BLOB_DLLFUNC MIL_INT MFTYPE MblobGetNumber(MIL_ID BlobResId, MIL_INT* CountVarPtr);
MIL_BLOB_DLLFUNC void MFTYPE MblobGetResult(MIL_ID BlobResId, MIL_INT64  Feature, void* TargetArrayPtr);
MIL_BLOB_DLLFUNC void MFTYPE MblobGetResultSingle(MIL_ID BlobResId, MIL_INT LabelVal, MIL_INT64  Feature, void* TargetVarPtr);
MIL_BLOB_DLLFUNC void MFTYPE MblobGetRuns(MIL_ID BlobResId, MIL_INT LabelVal, MIL_INT64  ArrayType,
                         void* RunXPtr, void* RunYPtr, void* RunLengthPtr);
MIL_BLOB_DLLFUNC MIL_INT MFTYPE MblobInquire(MIL_ID ResOrFeatListBlobId, MIL_INT64  InquireType, void* UserVarPtr);
MIL_BLOB_DLLFUNC void MFTYPE MblobLabel(MIL_ID BlobResId, MIL_ID DestImageBufId, MIL_INT64  Mode);
MIL_BLOB_DLLFUNC void MFTYPE MblobSelect(MIL_ID BlobResId, MIL_INT64  Operation, MIL_INT64  SelectionCriterion,
                        MIL_INT64  Condition, MIL_DOUBLE CondLow, MIL_DOUBLE CondHigh);
MIL_BLOB_DLLFUNC void MFTYPE MblobSelectFeature(MIL_ID FeatureListId, MIL_INT64  Feature);
MIL_BLOB_DLLFUNC void MFTYPE MblobSelectFeret(MIL_ID FeatureListId, MIL_DOUBLE Angle);
MIL_BLOB_DLLFUNC void MFTYPE MblobSelectMoment(MIL_ID FeatureListId, MIL_INT64  MomType,
                              MIL_INT XMomOrder, MIL_INT YMomOrder);
MIL_BLOB_DLLFUNC void MFTYPE MblobReconstruct(MIL_ID SrcImageBufId, MIL_ID SeedImageBufId,
                             MIL_ID DestImageBufId, MIL_INT64  Operation, MIL_INT64  ProcMode);
MIL_BLOB_DLLFUNC void MFTYPE MblobMerge(MIL_ID SourceResult1, MIL_ID SourceResult2,
                       MIL_ID DestResult, MIL_INT64  ControlFlag);

MIL_BLOB_DLLFUNC void MFTYPE MblobDraw(MIL_ID ContextGraId, MIL_ID ResultId, MIL_ID DstImageBufOrListGraId,
