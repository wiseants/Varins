...
#if M_MIL_USE_UNICODE
MIL_DLLFUNC void MFTYPE MgraSaveW(MIL_CONST_TEXT_PTR  FileName,
                      MIL_ID              GraphListId,
                      MIL_INT64           ControlFlag);

MIL_DLLFUNC MIL_ID MFTYPE MgraRestoreW(MIL_CONST_TEXT_PTR FileName,
                           MIL_ID             SystemId,
                           MIL_INT64          ControlFlag,
                           MIL_ID*            GraphListIdPtr);

MIL_DLLFUNC void MFTYPE MgraStreamW(MIL_TEXT_PTR MemPtrOrFileName,
                        MIL_ID       SystemId,
                        MIL_INT64    Operation,
...
MIL_DLLFUNC void MFTYPE MgraSaveA(const char*  FileName,
                      MIL_ID       GraphListId,
                      MIL_INT64    ControlFlag);

MIL_DLLFUNC MIL_ID MFTYPE MgraRestoreA(const char* FileName,
                           MIL_ID      SystemId,
                           MIL_INT64   ControlFlag,
                           MIL_ID*     GraphListIdPtr);

MIL_DLLFUNC void MFTYPE MgraStreamA(char*  MemPtrOrFileName,
                        MIL_ID       SystemId,
                        MIL_INT64    Operation,
                        MIL_INT64    StreamType,
                        MIL_DOUBLE   Version,
...
MIL_DLLFUNC void MFTYPE    MbufClearDouble      (MIL_ID DstImageBufId,
                                     MIL_DOUBLE Color);
...
MIL_DLLFUNC void MFTYPE    MbufClearCondDouble  (MIL_ID BufId,
...
MIL_DLLFUNC MIL_INT MFTYPE MbufGetArc              (MIL_ID     ImageBufId,
                                        MIL_INT    XCenter,
                                        MIL_INT    YCenter,
                                        MIL_INT    XRad,
                                        MIL_INT    YRad,
...
#if M_MIL_USE_UNICODE
MIL_DLLFUNC MIL_INT MFTYPE MbufDiskInquireA     (const char* FileName,
                                     MIL_INT64 InquireType,
                                     void* UserVarPtr);
MIL_DLLFUNC void MFTYPE    MbufSaveA            (const char* FileName,
                                     MIL_ID BufId);
MIL_DLLFUNC MIL_ID MFTYPE  MbufRestoreA         (const char* FileName,
                                     MIL_ID SystemId,
                                     MIL_ID* BufIdPtr);
MIL_DLLFUNC void MFTYPE    MbufLoadA            (const char* FileName,
                                     MIL_ID BufId);
MIL_DLLFUNC MIL_ID MFTYPE  MbufImportA          (const char* FileName,
                                     MIL_INT64 FileFormat,
                                     MIL_INT64 Operation,
                                     MIL_ID SystemId,
                                     MIL_ID* BufIdPtr);
MIL_DLLFUNC void MFTYPE    MbufExportA          (const char* FileName,
                                     MIL_INT64 FileFormat,
                                     MIL_ID SrcBufId);
MIL_DLLFUNC void MFTYPE    MbufExportSequenceA  (const char* FileName,
                                     MIL_INT64 FileFormat,
                                     const MIL_ID *BufArrayPtrOrSystemIdPtr,
                                     MIL_INT NumOfIds,
                                     MIL_DOUBLE FrameRate,
                                     MIL_INT64 ControlFlag);
MIL_DLLFUNC void MFTYPE    MbufImportSequenceA  (const char* FileName,
                                     MIL_INT64 FileFormat,
                                     MIL_INT64 Operation,
                                     MIL_ID SystemId,
                                     MIL_ID *BufArrayPtr,
...
MIL_DLLFUNC MIL_INT MFTYPE MbufDiskInquireW     (MIL_CONST_TEXT_PTR FileName,
                                     MIL_INT64 InquireType,
                                     void* UserVarPtr);

MIL_DLLFUNC void MFTYPE    MbufSaveW            (MIL_CONST_TEXT_PTR FileName,
                                     MIL_ID BufId);
MIL_DLLFUNC MIL_ID MFTYPE  MbufRestoreW         (MIL_CONST_TEXT_PTR FileName,
                                     MIL_ID SystemId,
                                     MIL_ID* BufIdPtr);
MIL_DLLFUNC void MFTYPE    MbufLoadW            (MIL_CONST_TEXT_PTR FileName,
                                     MIL_ID BufId);
MIL_DLLFUNC MIL_ID MFTYPE  MbufImportW          (MIL_CONST_TEXT_PTR FileName,
                                     MIL_INT64 FileFormat,
                                     MIL_INT64 Operation,
                                     MIL_ID SystemId,
                                     MIL_ID* BufIdPtr);
MIL_DLLFUNC void MFTYPE    MbufExportW          (MIL_CONST_TEXT_PTR FileName,
                                     MIL_INT64 FileFormat,
                                     MIL_ID SrcBufId);
MIL_DLLFUNC void MFTYPE    MbufExportSequenceW  (MIL_CONST_TEXT_PTR FileName,
                                     MIL_INT64 FileFormat,
                                     const MIL_ID *BufArrayPtrOrSystemIdPtr,
                                     MIL_INT NumOfIds,
                                     MIL_DOUBLE FrameRate,
                                     MIL_INT64 ControlFlag);
MIL_DLLFUNC void MFTYPE    MbufImportSequenceW  (MIL_CONST_TEXT_PTR FileName,
                                     MIL_INT64 FileFormat,
                                     MIL_INT64 Operation,
                                     MIL_ID SystemId,
                                     MIL_ID *BufArrayPtr,
...
#if M_MIL_USE_UNICODE
   MIL_DLLFUNC MIL_ID MFTYPE     MappAllocA(const char* ServerDescription, MIL_INT64 InitFlag, MIL_ID* ContextAppIdPtr);

   MIL_DLLFUNC MIL_ID MFTYPE     MappAllocW              (MIL_CONST_TEXT_PTR ServerDescription,
                                              MIL_INT64 InitFlag,
...
#if M_MIL_USE_UNICODE
MIL_DLLFUNC void MFTYPE       MappOpenConnectionA     (const char* ConnectionDescriptor,
                                           MIL_INT64 InitFlag,
                                           MIL_INT64 ControlFlag,
                                           MIL_ID* RemoteContextAppIdPtr);

MIL_DLLFUNC void MFTYPE       MappOpenConnectionW     (MIL_CONST_TEXT_PTR ConnectionDescriptor,
                                           MIL_INT64 InitFlag,
                                           MIL_INT64 ControlFlag,
                                           MIL_ID* RemoteContextAppIdPtr);
...
inline void MFTYPE MbufInquireFeatureUnsafeW  (MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void            *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool            *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int              UserVarPtr);
inline void MFTYPE MbufInquireFeatureUnsafeA  (MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, void            *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_INT64       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_INT32       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_UINT8       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, bool            *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, int              UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64      *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_UINT64      *UserVarPtr);
#endif

#else

inline void MFTYPE MbufInquireFeatureUnsafe  (MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void             *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR    *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64        *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE       *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32        *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8        *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool             *UserVarPtr);
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int               UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64       *UserVarPtr);
#endif
...
inline void MFTYPE MbufControlFeatureUnsafeW  (MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void            *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool            *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int              UserVarPtr);
inline void MFTYPE MbufControlFeatureUnsafeA  (MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const void            *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_INT64       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_INT32       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_UINT8       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const bool            *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType,       int              UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64      *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_UINT64      *UserVarPtr);
#endif

#else

inline void MFTYPE MbufControlFeatureUnsafe  (MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void             *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR    *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64        *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE       *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32        *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8        *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool             *UserVarPtr);
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int               UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64       *UserVarPtr);
#endif
#endif
...
inline void MFTYPE MsysInquireFeatureUnsafeW  (MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void            *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool            *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int              UserVarPtr);
inline void MFTYPE MsysInquireFeatureUnsafeA  (MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, void            *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_INT64       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_INT32       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_UINT8       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, bool            *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, int              UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64      *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char*        FeatureName, MIL_INT64 FeatureType, MIL_UINT64      *UserVarPtr);
#endif

#else

inline void MFTYPE MsysInquireFeatureUnsafe  (MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void             *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR    *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64        *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE       *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32        *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8        *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool             *UserVarPtr);
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int               UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64       *UserVarPtr);
#endif
...
inline void MFTYPE MsysControlFeatureUnsafeW  (MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void            *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool            *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int              UserVarPtr);
inline void MFTYPE MsysControlFeatureUnsafeA  (MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const void            *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR   *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_INT64       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE      *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_INT32       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_UINT8       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const bool            *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType,       int              UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64      *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char*        FeatureName, MIL_INT64 FeatureType, const MIL_UINT64      *UserVarPtr);
#endif

#else

inline void MFTYPE MsysControlFeatureUnsafe  (MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void             *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR    *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64        *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE       *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32        *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8        *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool             *UserVarPtr);
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int               UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64       *UserVarPtr);
#endif
#endif
...
inline MIL_INT64 MappInquireConnectionRequiredType(MIL_INT64 InquireType)
   {
   if ((InquireType == M_DMIL_PUBLISHED_LIST) || (InquireType == M_DMIL_PUBLISHED_NAME))
      return M_TYPE_MIL_ID;
...
inline MIL_INT64 InquireFeatureRequiredType(MIL_INT64 InquireType, MIL_INT64 FeatureType)
   {
   MIL_INT64 Type = 0;
   ...
   if((M_GET_INTERMOD_VALUE_BITS(InquireType) == M_STRING_SIZE) || (InquireType & M_FEATURE_SIZE))
      ...
      Type = M_TYPE_INT64;
   else if(M_FEATURE_OP(InquireType) == M_FEATURE_CHANGE_HOOK)
      Type = M_TYPE_MIL_INT;
   ...
   if(Type == 0)
      ...
      switch(FeatureType)
         ...
         default:
            ...
            else if(M_STRING_ARRAY_SIZE_BIT_SET(FeatureType))
               Type = M_TYPE_TEXT_CHAR;
            else
               Type = 0;
            break;
...
inline MIL_INT64 ControlFeatureRequiredType(MIL_INT64 ControlType, MIL_INT64 FeatureType)
   {
   MIL_INT64 Type = 0;

   if(M_FEATURE_OP(ControlType) == M_FEATURE_VALUE_AS_STRING)
      Type = M_TYPE_TEXT_CHAR;
   else if(M_FEATURE_OP(ControlType) == M_FEATURE_CHANGE_HOOK)
      Type = M_TYPE_MIL_INT;
   else
      {
      switch(FeatureType)
...
#if M_MIL_USE_UNICODE
inline void MFTYPE MbufInquireFeatureExecuteW (MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = InquireFeatureRequiredType(InquireType, FeatureType);

   if (RequiredType != GivenType)
      SafeTypeError(MIL_TEXT("MbufInquireFeature"));

   MbufInquireFeatureW(BufId, InquireType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MbufInquireFeatureExecuteA (MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = InquireFeatureRequiredType(InquireType, FeatureType);
   ...
   MbufInquireFeatureA(BufId, InquireType, FeatureName, FeatureType, UserVarPtr);
   }
...
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR  *UserVarPtr)
   {
   MbufInquireFeatureExecuteW(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64      *UserVarPtr)
   {
   MbufInquireFeatureExecuteW(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE     *UserVarPtr)
   {
   MbufInquireFeatureExecuteW(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32      *UserVarPtr)
   {
   MbufInquireFeatureExecuteW(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8      *UserVarPtr)
   {
   MbufInquireFeatureExecuteW(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool           *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MbufInquireFeature"));
...
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MbufInquireFeatureW(BufId, InquireType, FeatureName, FeatureType, M_NULL);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufInquireFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR  *UserVarPtr)
   {
   MbufInquireFeatureExecuteA(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_INT64      *UserVarPtr)
   {
   MbufInquireFeatureExecuteA(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE     *UserVarPtr)
   {
   MbufInquireFeatureExecuteA(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_INT32      *UserVarPtr)
   {
   MbufInquireFeatureExecuteA(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_UINT8      *UserVarPtr)
   {
   MbufInquireFeatureExecuteA(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, bool           *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MbufInquireFeature"));
...
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MbufInquireFeatureA(BufId, InquireType, FeatureName, FeatureType, M_NULL);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufInquireFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
inline void MFTYPE MbufInquireFeatureExecute (MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = InquireFeatureRequiredType(InquireType, FeatureType);
   ...
   MbufInquireFeature(BufId, InquireType, FeatureName, FeatureType, UserVarPtr);
   }
inline void MFTYPE MbufInquireFeatureUnsafe  (MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void           *UserVarPtr)
   {
   MbufInquireFeature(BufId, InquireType, FeatureName, FeatureType, UserVarPtr);
...
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR  *UserVarPtr)
   {
   MbufInquireFeatureExecute(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64      *UserVarPtr)
   {
   MbufInquireFeatureExecute(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE     *UserVarPtr)
   {
   MbufInquireFeatureExecute(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32      *UserVarPtr)
   {
   MbufInquireFeatureExecute(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8      *UserVarPtr)
   {
   MbufInquireFeatureExecute(BufId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool           *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MbufInquireFeature"));
...
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MbufInquireFeature(BufId, InquireType, FeatureName, FeatureType, (void*)UserVarPtr);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufInquireFeatureSafeType(MIL_ID BufId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
#if M_MIL_USE_UNICODE
inline void MFTYPE MbufControlFeatureExecuteW (MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);

   if (RequiredType != GivenType)
      SafeTypeError(MIL_TEXT("MbufControlFeature"));

   MbufControlFeatureW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MbufControlFeatureExecuteW (MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MbufControlFeatureW(BufId, ControlType, FeatureName, FeatureType, (const void*)UserVarPtr);
   }

inline void MFTYPE MbufControlFeatureExecuteA (MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MbufControlFeatureA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MbufControlFeatureExecuteA (MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, int UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MbufControlFeatureA(BufId, ControlType, FeatureName, FeatureType, (const void*)UserVarPtr);
   }
...
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR   *UserVarPtr)
   {
   MbufControlFeatureExecuteW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64       *UserVarPtr)
   {
   MbufControlFeatureExecuteW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE      *UserVarPtr)
   {
   MbufControlFeatureExecuteW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32       *UserVarPtr)
   {
   MbufControlFeatureExecuteW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8       *UserVarPtr)
   {
   MbufControlFeatureExecuteW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool            *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MbufControlFeature"));
...
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int              UserVarPtr)
   {
   MbufControlFeatureExecuteW(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, FeatureType);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufControlFeatureSafeTypeW(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64      *UserVarPtr)
   {
...
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR          *UserVarPtr)
   {
   MbufControlFeatureExecuteA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_INT64              *UserVarPtr)
   {
   MbufControlFeatureExecuteA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE             *UserVarPtr)
   {
   MbufControlFeatureExecuteA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_INT32              *UserVarPtr)
   {
   MbufControlFeatureExecuteA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_UINT8              *UserVarPtr)
   {
   MbufControlFeatureExecuteA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const bool                   *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MbufControlFeature"));
...
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType,       int                     UserVarPtr)
   {
   MbufControlFeatureExecuteA(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, FeatureType);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufControlFeatureSafeTypeA(MIL_ID BufId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_UINT64             *UserVarPtr)
   {
...
#else
inline void MFTYPE MbufControlFeatureExecute (MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MbufControlFeature(BufId, ControlType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MbufControlFeatureExecute (MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int  UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MbufControlFeature(BufId, ControlType, FeatureName, FeatureType, (const void*)UserVarPtr);
   }
...
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR    *UserVarPtr)
   {
   MbufControlFeatureExecute(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64        *UserVarPtr)
   {
   MbufControlFeatureExecute(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE       *UserVarPtr)
   {
   MbufControlFeatureExecute(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32        *UserVarPtr)
   {
   MbufControlFeatureExecute(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8        *UserVarPtr)
   {
   MbufControlFeatureExecute(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool             *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MbufControlFeature"));
...
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int               UserVarPtr)
   {
   MbufControlFeatureExecute(BufId, ControlType, FeatureName, FeatureType, UserVarPtr, FeatureType);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MbufControlFeatureSafeType(MIL_ID BufId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64       *UserVarPtr)
   {
...
inline void MFTYPE MdigInquireFeatureSafeType(MIL_ID DigId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MdigInquireFeature(DigId, InquireType, FeatureName, FeatureType, (void*)UserVarPtr);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MdigInquireFeatureSafeType(MIL_ID DigId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
#if M_MIL_USE_UNICODE
inline void MFTYPE MsysInquireFeatureExecuteW (MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = InquireFeatureRequiredType(InquireType, FeatureType);
   ...
   MsysInquireFeatureW(SysId, InquireType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MsysInquireFeatureExecuteA (MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = InquireFeatureRequiredType(InquireType, FeatureType);
   ...
   MsysInquireFeatureA(SysId, InquireType, FeatureName, FeatureType, UserVarPtr);
   }
...
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR  *UserVarPtr)
   {
   MsysInquireFeatureExecuteW(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64      *UserVarPtr)
   {
   MsysInquireFeatureExecuteW(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE     *UserVarPtr)
   {
   MsysInquireFeatureExecuteW(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32      *UserVarPtr)
   {
   MsysInquireFeatureExecuteW(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8      *UserVarPtr)
   {
   MsysInquireFeatureExecuteW(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool           *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MsysInquireFeature"));
...
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MsysInquireFeatureW(SysId, InquireType, FeatureName, FeatureType, M_NULL);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysInquireFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR  *UserVarPtr)
   {
   MsysInquireFeatureExecuteA(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_INT64      *UserVarPtr)
   {
   MsysInquireFeatureExecuteA(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE     *UserVarPtr)
   {
   MsysInquireFeatureExecuteA(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_INT32      *UserVarPtr)
   {
   MsysInquireFeatureExecuteA(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_UINT8      *UserVarPtr)
   {
   MsysInquireFeatureExecuteA(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, bool           *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MsysInquireFeature"));
...
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MsysInquireFeatureA(SysId, InquireType, FeatureName, FeatureType, M_NULL);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysInquireFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 InquireType, const char* FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
inline void MFTYPE MsysInquireFeatureExecute (MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = InquireFeatureRequiredType(InquireType, FeatureType);
   ...
   MsysInquireFeature(SysId, InquireType, FeatureName, FeatureType, UserVarPtr);
   }
inline void MFTYPE MsysInquireFeatureUnsafe  (MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, void           *UserVarPtr)
   {
   MsysInquireFeature(SysId, InquireType, FeatureName, FeatureType, UserVarPtr);
...
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_TEXT_CHAR  *UserVarPtr)
   {
   MsysInquireFeatureExecute(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT64      *UserVarPtr)
   {
   MsysInquireFeatureExecute(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_DOUBLE     *UserVarPtr)
   {
   MsysInquireFeatureExecute(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_INT32      *UserVarPtr)
   {
   MsysInquireFeatureExecute(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT8      *UserVarPtr)
   {
   MsysInquireFeatureExecute(SysId, InquireType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, bool           *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MsysInquireFeature"));
...
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int             UserVarPtr)
   ...
   MsysInquireFeature(SysId, InquireType, FeatureName, FeatureType, (void*)UserVarPtr);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysInquireFeatureSafeType(MIL_ID SysId, MIL_INT64 InquireType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, MIL_UINT64     *UserVarPtr)
   {
...
#if M_MIL_USE_UNICODE
inline void MFTYPE MsysControlFeatureExecuteW (MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MsysControlFeatureW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MsysControlFeatureExecuteW (MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MsysControlFeatureW(SysId, ControlType, FeatureName, FeatureType, (const void*)UserVarPtr);
   }

inline void MFTYPE MsysControlFeatureExecuteA (MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MsysControlFeatureA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MsysControlFeatureExecuteA (MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, int UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MsysControlFeatureA(SysId, ControlType, FeatureName, FeatureType, (const void*)UserVarPtr);
   }
...
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR   *UserVarPtr)
   {
   MsysControlFeatureExecuteW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64       *UserVarPtr)
   {
   MsysControlFeatureExecuteW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE      *UserVarPtr)
   {
   MsysControlFeatureExecuteW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32       *UserVarPtr)
   {
   MsysControlFeatureExecuteW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8       *UserVarPtr)
   {
   MsysControlFeatureExecuteW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool            *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MsysControlFeature"));
...
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int              UserVarPtr)
   {
   MsysControlFeatureExecuteW(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, FeatureType);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysControlFeatureSafeTypeW(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64      *UserVarPtr)
   {
...
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR          *UserVarPtr)
   {
   MsysControlFeatureExecuteA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_INT64              *UserVarPtr)
   {
   MsysControlFeatureExecuteA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE             *UserVarPtr)
   {
   MsysControlFeatureExecuteA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_INT32              *UserVarPtr)
   {
   MsysControlFeatureExecuteA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_UINT8              *UserVarPtr)
   {
   MsysControlFeatureExecuteA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const bool                   *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MsysControlFeature"));
...
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType,       int                     UserVarPtr)
   {
   MsysControlFeatureExecuteA(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, FeatureType);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysControlFeatureSafeTypeA(MIL_ID SysId, MIL_INT64 ControlType, const char* FeatureName, MIL_INT64 FeatureType, const MIL_UINT64             *UserVarPtr)
   {
...
#else
inline void MFTYPE MsysControlFeatureExecute (MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const void  *UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MsysControlFeature(SysId, ControlType, FeatureName, FeatureType, UserVarPtr);
   }

inline void MFTYPE MsysControlFeatureExecute (MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, int  UserVarPtr, MIL_INT64 GivenType)
   {
   MIL_INT64 RequiredType = ControlFeatureRequiredType(ControlType, FeatureType);
   ...
   MsysControlFeature(SysId, ControlType, FeatureName, FeatureType, (const void*)UserVarPtr);
   }
...
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_TEXT_CHAR    *UserVarPtr)
   {
   MsysControlFeatureExecute(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_TEXT_CHAR);
   }
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT64        *UserVarPtr)
   {
   MsysControlFeatureExecute(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_INT64);
   }
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_DOUBLE       *UserVarPtr)
   {
   MsysControlFeatureExecute(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_DOUBLE);
   }
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_INT32        *UserVarPtr)
   {
   MsysControlFeatureExecute(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_MIL_INT32);
   }
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT8        *UserVarPtr)
   {
   MsysControlFeatureExecute(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, M_TYPE_REGISTER);
   }
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const bool             *UserVarPtr)
   {
   SafeTypeError(MIL_TEXT("MsysControlFeature"));
...
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType,       int               UserVarPtr)
   {
   MsysControlFeatureExecute(SysId, ControlType, FeatureName, FeatureType, UserVarPtr, FeatureType);
   }
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline void MFTYPE MsysControlFeatureSafeType(MIL_ID SysId, MIL_INT64 ControlType, MIL_CONST_TEXT_PTR FeatureName, MIL_INT64 FeatureType, const MIL_UINT64       *UserVarPtr)
   {
