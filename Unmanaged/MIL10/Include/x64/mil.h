...
#define M_GENTL_PRODUCER_BIT                          0x80000000
#define M_GENTL_PRODUCER_MASK                         0x7F000000
...
#define M_GENTL_XML_TYPE_MASK                         MAKE_INT64(0x000000000E000000)
...
#define M_GENTL_XML_INDEX_SHIFT_UPPER                 MAKE_INT64(44)
...
#define M_GENTL_INTERFACE_NUMBER(N)                  (M_GENTL_INTERFACE | (((N) << M_GENTL_XML_INDEX_SHIFT_LOWER) & M_GENTL_XML_INDEX_MASK_LOWER) | (((N) << M_GENTL_XML_INDEX_SHIFT_UPPER) & M_GENTL_XML_INDEX_MASK_UPPER))
...
#define M_GENTL_STREAM_NUMBER(N)                     (M_GENTL_STREAM | (((N) << M_GENTL_XML_INDEX_SHIFT_LOWER) & M_GENTL_XML_INDEX_MASK_LOWER) | (((N) << M_GENTL_XML_INDEX_SHIFT_UPPER) & M_GENTL_XML_INDEX_MASK_UPPER))
...
#define M_WEB_CLIENT_CONNECTED                       15L
#define M_WEB_CLIENT_DISCONNECTED                    16L
#define M_WEB_CONNECTION_LOST                        17L
#define M_ERROR_FATAL                                 (M_ERROR|M_FATAL)
#define M_UNHOOK                                      0x04000000L
#define M_THREAD_RECURSIVE                            0x00800000L /* Bit field exclusive to M_TRACE  to M_PROCESSING      (3L to 6L) */
#define M_THREAD_CURRENT                              0x01000000L /*                        M_TRACE_START                       (1L) */
...
#define M_IS_MILWEB_HOOK(hooktype)                    ((hooktype==M_WEB_CLIENT_CONNECTED) || (hooktype==M_WEB_CLIENT_DISCONNECTED) || (hooktype==M_WEB_CONNECTION_LOST))
...
#define M_WEB_CONNECTION                              (M_APP_INQUIRE_SYS_START+521L)   
#define M_WEB_CONNECTION_PORT                         (M_APP_INQUIRE_SYS_START+522L)
...
#define M_GENTL_PRODUCER_DESCRIPTOR             ((M_APP_INQUIRE_SYS_START+7192L)|M_CLIENT_ASCII_MODE)
/* Reserve next 63 values               from    ((M_APP_INQUIRE_SYS_START+7193L)|M_CLIENT_ASCII_MODE)*/
/*                                      to      ((M_APP_INQUIRE_SYS_START+7255L)|M_CLIENT_ASCII_MODE)*/
...
#define M_GENTL_PRODUCER_DESCRIPTOR             (M_APP_INQUIRE_SYS_START+7192L)
/* Reserve next 63 values               from    (M_APP_INQUIRE_SYS_START+7193L)*/
/*                                      to      (M_APP_INQUIRE_SYS_START+7255L)*/
#endif
...
#define M_REG_DEF_SYSTEM_INIT_FLAG              (M_APP_INQUIRE_SYS_START+9728L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+9729L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+9791L)*/
#endif
...
#endif
#define M_WEB_PUBLISHED_LIST                    M_DMIL_PUBLISHED_LIST
#define M_WEB_PUBLISHED_LIST_SIZE               M_DMIL_PUBLISHED_LIST_SIZE
#define M_WEB_PUBLISHED_NAME                    M_DMIL_PUBLISHED_NAME
