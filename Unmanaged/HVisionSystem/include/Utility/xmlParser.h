...
public:
	...
	static XMLNode openFileHelper(void* archive, XMLCSTR     filename, XMLCSTR tag = NULL);
	...
	XMLCSTR getAttribute(XMLCSTR lpszAttrib, XMLCSTR lpszdef = _T(""));
	...
	void* getArchive() const;									   ///< return archive pointer
	/** @} */
	...
	static void* pArchive;

	void SetValue(LPCTSTR lpszTitle, LPCTSTR lpszSection, LPCTSTR lpszValue);
	CString GetValue(LPCTSTR lpszTitle, LPCTSTR lpszSection, LPCTSTR lpszDefaultStr = _T(""));
	void SetValueLong(LPCTSTR lpszTitle, LPCTSTR lpszSection, long nValue);
	long GetValueLong(LPCTSTR lpszTitle, LPCTSTR lpszSection, long nDefaultValue = 0);
	void SetValueDouble(LPCTSTR lpszTitle, LPCTSTR lpszSection, double nValue);
	double GetValueDouble(LPCTSTR lpszTitle, LPCTSTR lpszSection, double lfDefaultValue = 0);
	void SetValueULONG(LPCTSTR lpszTitle, LPCTSTR lpszSection, ULONG nValue);
	ULONG GetValueULONG(LPCTSTR lpszTitle, LPCTSTR lpszSection, ULONG nDefaultValue = 0);
	 ...
	 * @ingroup xmlModify
	 * @{ */
	static XMLNode createXMLTopNode(void* archive, XMLCSTR lpszName, char isDeclaration = FALSE);                    ///< Create the top node of an XMLNode structure
  ...
  private:
	  ...
	  typedef struct XMLNodeDataTag // to allow shallow copy and "intelligent/smart" pointers (automatic delete):
	  {
		  ...
		  void					 *archive;		  //pcbmodel void pointer
	  } XMLNodeData;
	  XMLNodeData *d;
