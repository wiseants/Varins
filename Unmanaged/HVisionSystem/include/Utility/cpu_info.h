...
#define STORE_CLASSICAL_NAME(x)		sprintf_s (ChipID.ProcessorName, CHIPNAME_STRING_LENGTH, x)
...
public:
	...
	// Functions.
#ifdef _WIN64
	__int64 __cdecl GetCyclesDifference (DELAY_FUNC, unsigned int){return 0 ;};
#else
...
private:
	...
	//swkim - 64bit의 경우 해당 함수를 사용하지 않도록 함.
#ifdef _WIN64
	bool __cdecl DoesCPUSupportCPUID (){return true;}
	bool __cdecl RetrieveCPUFeatures (){return true;}
	bool __cdecl RetrieveCPUIdentity (){return true;}
	bool __cdecl RetrieveCPUCacheDetails (){return true;}
	bool __cdecl RetrieveClassicalCPUCacheDetails (){return true;}	
	bool __cdecl RetrieveClassicalCPUClockSpeed (){return true;}
	bool __cdecl RetrieveCPUExtendedLevelSupport (int){return true;}
	bool __cdecl RetrieveExtendedCPUFeatures (){return true;}
	bool __cdecl RetrieveProcessorSerialNumber (){return true;}
	bool __cdecl RetrieveCPUPowerManagement (){return true;}	
	bool __cdecl RetrieveExtendedCPUIdentity (){return true;}
