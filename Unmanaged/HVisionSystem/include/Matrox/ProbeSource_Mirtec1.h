// ProbeSource_OCX.h: interface for the CProbeSource_Mirtec1 class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PROBESOURCE_MIRTEC1_H__71E202D1_A5EC_4FA2_B85F_87B0A71DBF3F__INCLUDED_)
#define AFX_PROBESOURCE_MIRTEC1_H__71E202D1_A5EC_4FA2_B85F_87B0A71DBF3F__INCLUDED_
...
#include "matrix.h"
#include "MoireMeasure.h"
#include "Structures.h"


class MATROXCLASS CProbeSource_Mirtec1 : public CProbeSource
{
public:
	void Synthesize_AB(int size);
	void CalcHeight(BYTE** img, LpSolder pSolder, CSPIResult& spiResult, ROISize roi, int probeType);
	CProbeSource_Mirtec1(CMilDigitizer* pMilDigitizer);
	virtual ~CProbeSource_Mirtec1();
...
protected:
	...
	void Calculate(LpSolder pSolder, CSPIResult& spiResult);
...
private:
	...
	float* m_pObjectPhase;

	CMoireMeasure m_moireMeasureA;
	CMoireMeasure m_moireMeasureB;
};

#endif // !defined(AFX_PROBESOURCE_MIRTEC1_H__71E202D1_A5EC_4FA2_B85F_87B0A71DBF3F__INCLUDED_)
